...
lisa_bp = Blueprint("lisa", __name__)


@lisa_bp.route("/api/lisa")
def api_mercury():
...
@lisa_bp.route("/api/lisa/knowledge")
...
@lisa_bp.route("/api/lisa/reply", methods=["POST"])
...
@lisa_bp.route("/api/lisa/review", methods=["POST"])
...
@lisa_bp.route("/api/lisa/review/<item_id>", methods=["POST"])
...
@lisa_bp.route("/api/lisa/go-live", methods=["POST"])
...
@lisa_bp.route("/api/lisa/live-config")
...
@lisa_bp.route("/api/lisa/comments")
...
@lisa_bp.route("/api/lisa/comment/analyze", methods=["POST"])
...
@lisa_bp.route("/api/lisa/comment/<comment_id>/status", methods=["POST"])
...
@lisa_bp.route("/api/lisa/pipeline/run", methods=["POST"])
...
@lisa_bp.route("/api/lisa/pipeline/stats")
...
@lisa_bp.route("/api/lisa/pipeline/approve/<item_id>", methods=["POST"])
...
@lisa_bp.route("/api/lisa/pipeline/reject/<item_id>", methods=["POST"])
...
@lisa_bp.route("/api/lisa/rate", methods=["POST"])
def api_lisa_rate():
...
@lisa_bp.route("/api/lisa/write", methods=["POST"])
def api_lisa_write():
...
@lisa_bp.route("/api/lisa/optimal-slot", methods=["POST"])
...
@lisa_bp.route("/api/lisa/jordan-queue")
...
@lisa_bp.route("/api/lisa/jordan-approve/<item_id>", methods=["POST"])
...
@lisa_bp.route("/api/lisa/posting-schedule")
...
@lisa_bp.route("/api/lisa/platform-status")
...
@lisa_bp.route("/api/lisa/broadcasts")
...
@lisa_bp.route("/api/lisa/x-mentions")
...
@lisa_bp.route("/api/lisa/x-competitors")
...
@lisa_bp.route("/api/lisa/x-competitors/scan", methods=["POST"])
...
@lisa_bp.route("/api/lisa/generate-image", methods=["POST"])
...
@lisa_bp.route("/api/lisa/image-costs")
...
@lisa_bp.route("/api/lisa/post-now/<item_id>", methods=["POST"])
...
@lisa_bp.route("/api/lisa/auto-poster-status")
...
@lisa_bp.route("/api/lisa/x-reply/<comment_id>", methods=["POST"])
...
@lisa_bp.route("/api/lisa/reply-opportunities")
...
@lisa_bp.route("/api/lisa/reply-hunt", methods=["POST"])
...
@lisa_bp.route("/api/lisa/reply-post/<opp_id>", methods=["POST"])
...
@lisa_bp.route("/api/lisa/reply-history")
...
@lisa_bp.route("/api/lisa/competitor-playbook")
...
@lisa_bp.route("/api/lisa/intelligence")
...
@lisa_bp.route("/api/lisa/intelligence/check-engagement", methods=["POST"])
...
@lisa_bp.route("/api/lisa/intelligence/memory")
def api_lisa_memory():
...
@lisa_bp.route("/api/lisa/intelligence/user/<username>")
